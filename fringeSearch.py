...
def usage(exitCode=None):
    print """fringeSearch.py - Given a collection of .npz files generated by "the next 
generation of correlator", search for fringes.

Usage:
fringeSearch.py [OPTIONS] npz [npz [...]]
...
def parseConfig(args):
    ...
    try:
        opts, args = getopt.getopt(args, "hr:b:d:l:ye:a:p", ["help", "baseline=", "ref-ant=", "decimate=", "limit=", "y-only", "delay-window=", "rate-window=", "plot"])
