...
def usage(exitCode=None):
	print """fringeSearchFine.py - Given a collection of .npz files generated by "the next 
generation of correlator", search for fringes.

Usage:
fringeSearchFine.py [OPTIONS] npz [npz [...]]

Options:
-h, --help                  Display this help information
-r, --ref-ant               Reference antenna (default = first)
...
def main(args):
	...
	delay = numpy.linspace(-dMax, dMax, 2*int(dMax*1e6/0.05)+1)			# s
	drate = numpy.linspace(-rMax, rMax, 2*int(rMax*1e3/1.00)+1)			# Hz
