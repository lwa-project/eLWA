...
__all__ = ['InterProcessLock', 'EnhancedFixedBody', 'EnhancedSun', 
           ...
           'nsround', 'read_correlator_configuration', 
           'extract_correlator_config', 'get_better_time', 
...
def read_correlator_configuration(filename):
    """
...
def extract_correlator_config(filename_or_npz):
    """
    Parse a correlator configuration file generated by createConfigFile.py and
    stored inside a .npz file.  Returns a seven-element tuple of:
      * a correlator configuration dictionary or None if no configuraiton is found
      * the reference source as a ephem.FixedBody-compatible instance
      * a list of filenames, 
      * a list of metadata tarball names, 
    ...
    # Read
    full_config = read_correlator_configuration(tempConfig)
