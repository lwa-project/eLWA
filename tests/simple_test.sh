...
python ../createConfigFile.py -o elwa.config 0* *.vdif LT004_*.tgz
python ../superCorrelator.py -t 1 -l 256 -j -g elwa elwa.config > elwa.log
...
python ../createConfigFile.py -o lwaonly.config 0* LT004_*.tgz
python ../superCorrelator.py -t 1 -l 256 -j -w 1 -g lwaonlyL lwaonly.config > lwaonlyL.log
python ../superCorrelator.py -t 1 -l 256 -j -w 2 -g lwaonlyH lwaonly.config > lwaonlyH.log
